...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-0077B5?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/tilak-vasani-65b7862a9/)
[![Gmail](https://img.shields.io/badge/Gmail-D14836?style=for-the-badge&logo=gmail&logoColor=white)](mailto:vasanitilak119@gmail.com)
[![GitHub](https://img.shields.io/badge/GitHub-100000?style=for-the-badge&logo=github&logoColor=white)](https://github.com/Tilakvasani)
&nbsp;
[![](https://visitcount.itsvg.in/api?id=Tilakvasani&icon=6&color=9&label=Profile+Views&pretty=true)](https://visitcount.itsvg.in)
...
tilak = {
    ...
    "shipped"  : [
        ...
        "DocForge AI      — Enterprise multi-agent documentation platform",
        "WhatsApp AI Bot  — Context-aware support assistant with RAG",
        "PS5 E-Commerce   — Full-stack platform with payments & AI support",
    ],
    "core_stack" : ["FastAPI", "LangGraph", "LangChain", "Azure OpenAI", "RAG", "PostgreSQL"],
    "vector_dbs" : ["FAISS", "ChromaDB", "Pinecone", "Milvus"],
    "fun_fact"   : "Cut query latency by 40% in production — pure prompt engineering"
}
```
...
- Designed and deployed **5+ production Gen AI systems** using LLMs, RAG architectures, and vector databases — reduced average query latency by **40%** through prompt engineering and pipeline optimization
- Engineered **multi-agent orchestration** frameworks with LangChain and Deep Agents handling 10+ concurrent enterprise workloads
- Built enterprise-grade **AI documentation platform** with FastAPI, LangChain, LangGraph, and MCP-based HubSpot integrations
- Implemented **RAG pipelines**, semantic search, vector embeddings, RAGAS-based evaluation, and scalable Docker-deployed APIs
...
|:--------|:------------|:------|
| **MCP Chat** | Universal AI agent connecting 8+ MCP services with LangGraph ReAct, SHA-256 caching, OAuth 2.0 PKCE & SSE streaming | FastAPI · LangGraph · Azure OpenAI · MCP · RAG |
...
<img width="100%" src="https://github-readme-activity-graph.vercel.app/graph?username=Tilakvasani&theme=tokyo-night&hide_border=true&area=true&area_color=A855F7&line=A855F7&point=ffffff" />
...
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="https://raw.githubusercontent.com/Tilakvasani/Tilakvasani/output/snake-dark.svg" />
  <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/Tilakvasani/Tilakvasani/output/snake.svg" />
  <img alt="Snake animation" src="https://raw.githubusercontent.com/Tilakvasani/Tilakvasani/output/snake.svg" width="100%" />
</picture>
